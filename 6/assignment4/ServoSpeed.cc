...
int main(){
	...
	std::cout << "Enter a start position  between 0 and 180: ";
	std::cin >> start_angle;

	std::cout << "Enter a end position  between 0 and 180: ";
	std::cin >> end_angle;

	std::cout << "Enter a rotational speed in degrees per second: ";
	std::cin >> rot_speed;
